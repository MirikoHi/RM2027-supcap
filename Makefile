##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.9.0-B19] date: [Wed May 27 23:09:43 CST 2026]
##########################################################################################################################
...
clean:
ifeq ($(OS),Windows_NT)
	-del /q $(BUILD_DIR)\*.o $(BUILD_DIR)\*.lst $(BUILD_DIR)\*.d >nul
else
